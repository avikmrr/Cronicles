...
class GooglePlayAPI(object):
    ...
    def download(self, packageName, versionCode, offerType=1):
        ...
        try:
            ...
            print self.toStr(message)
            # if "Google Play purchases are not supported in your country" in self.toStr(message):
            #     print "App is Not Available in India"
            # else:
            #     print "Paid App"
            ...
            return response.content, self.toStr(message)
        except Exception as e:
            return None, self.toStr(message)
